...
Predictive Tool Note

## Purpose

This entry records a predictive model or surrogate that can guide protocol search, extrapolation, or failure diagnosis.
...
- [Deep recurrent networks predicting the gap evolution in adiabatic quantum computing](../04_Papers/Quantum_2023_Gap_Recurrent.md)
